...
import { FaBook, FaListOl } from "react-icons/fa";
...
import collapsed_logo from '../../assets/img/icon/Hack_cat.png';
...
const Sidebar: React.FC<SidebarProps> = ({ isCollapsed, toggleSidebar }) => {
  ...
  const isProblemBankActive = location.pathname.startsWith('/problem-bank');
        ...
        <div className={styles.headerParent}>
          <div className={styles.topMenu}>
            <li className={styles.verticalMenuList}>
              ...
              <Link
                to="/problem-bank"
                className={`${styles.verticalMenuItem} ${isProblemBankActive ? styles.selected : ''}`}
                data-tooltip="Problem Bank"
              >
                <FaListOl className={styles.menuIcon} />
                <div className={styles.label}>Problem Bank</div>
              </Link>
